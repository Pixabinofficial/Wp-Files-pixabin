//<![CDATA[
	/** Pixabindownloadredirect **/
	const Pixabindownloadredirect = document.getElementById('Pixabindownloadredirect');
	const Pixabindownloadredirect_loading = document.getElementById('pixabin-Pixabindownloadredirect-loading-RX');
	if (Pixabindownloadredirect && Pixabindownloadredirect_loading) {
	    setTimeout(function() {
	        Pixabindownloadredirect_loading.style.display = 'none';
	        Pixabindownloadredirect.style.display = 'block';
	    }, 20000);
	}

	const Pixabindownloadredirect_button = document.getElementById('Pixabindownloadredirect-button');
	const Pixabindownloadredirected_text = document.getElementById('btngetlink');
	if (Pixabindownloadredirect_button && Pixabindownloadredirected_text) {
	    Pixabindownloadredirect_button.addEventListener('click', function() {
	        setTimeout(function() {
	            Pixabindownloadredirected_text.style.display = 'block';
	            Pixabindownloadredirected_text.style.animation = 'fade-in 1s';
	        }, 1500);
	    });
	}
	...
	$(document).ready(function() {
	    ...
	    if ($.urlParam('download') == null) {
	        Pixabinprobee.style.display = 'none';
	    } else {
	        percentVal = 0;
	    ...
	    $('body').on('click', '#btn-gotolink', function() {
	        var realurl = aesCrypto.decrypt(convertstr($.urlParam('download')), convertstr('root'));
	        window.open(realurl, '_blank');

	    });
	});
	$(function() {
	    $(".separator:first").remove(), $(".post_body > img:first").remove()
	});
